namespace SOLID.Data
{
    public static class InventarioDatabaseQueries
    {
        ...
        public const string List_Producto = "select Codigo, Nombre, IdTipoProducto, ValorCompra, ValorVenta, Iva" +
            ", CodigoBarras, ProveedorId, UserCreated, EstadoId from Producto order by nombre asc";
    }
}